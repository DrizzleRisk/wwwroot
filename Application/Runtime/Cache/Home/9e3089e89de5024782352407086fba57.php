...
<head>
    ...
    <script>
        ...
        $(function(){
            ...
            $('form').ajaxForm({
                dataType: 'json',
                url: '/index.php/service/kk_upload',
...
<div class="row jg-banner">
    <div class="jg-func clearfix">
        ...
        <form action="http://service.security.tencent.com/index.php/service/upload" method="post" accept-charset="utf-8" style="margin-left: 50px;float:left;position: relative; overflow: hidden;" enctype="multipart/form-data"><div style="display:none">
<input type="hidden" name="csrf_token" value="9224374036c81177f0ea5591b71b696e" />
</div>        <input type="file"  accept=".apk" id="txtFile" name="uploadAPK">
